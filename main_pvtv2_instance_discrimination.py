...
from utils.multicrop_dataset_merge import MultiCropMergeDataset

# from models.model import ViT
# import models.margin_model as vit_models
import models.pvt_modelv2 as pvtv2_models
import models.margin_pvt_modelv2 as margin_pvtv2_models

model_names = sorted(name for name in pvtv2_models.__dict__
...
def main():
    ...
    if args.merge:
        dataset_name = dataset_name + '+IN_1000'
        args.num_classes = args.num_classes + 1000
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = pvtv2_models.__dict__[args.arch](img_size=args.size_crops[0],
    ...
    if args.merge:
        train_dataset = MultiCropMergeDataset(
            traindir,
            '/opt/caoyh/datasets/small_imagenet_class_1000_n_1',
            args.size_crops,
            args.nmb_crops,
